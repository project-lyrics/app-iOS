//
//  FeelinPagerTabViewController.swift
//  SharedDesignSystem
//
...
open class FeelinPagerTabViewController: UIViewController, UIScrollViewDelegate {
    ...
    open func viewControllers(for pagerTabStripController: FeelinPagerTabViewController) -> [UIViewController] {
    ...
    open func reloadPagerTabStripView() {
        ...
        containerView.contentSize = CGSize(
            width: containerView.bounds.width * CGFloat(viewControllers.count),
