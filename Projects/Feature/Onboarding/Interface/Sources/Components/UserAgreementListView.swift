...
final class UseAgreementListView: UIView {
    ...
    lazy var allAgreeButton: UIButton = {
        ...
        button.configurationUpdateHandler = { [weak self] button in
            switch button.state {
            case .normal:
                button.configuration?.baseForegroundColor = Colors.gray04
                button.configuration?.baseBackgroundColor = Colors.background
                self?.allAgreeLabel.textColor = Colors.gray04
            case .selected:
                button.configuration?.baseBackgroundColor = Colors.alertSuccess
                self?.allAgreeLabel.textColor = Colors.alertSuccess
