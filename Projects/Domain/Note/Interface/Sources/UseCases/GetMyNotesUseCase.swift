...
public protocol GetMyNotesUseCaseInterface {
    func execute(
        isInitial: Bool,
        perPage: Int,
        artistID: Int?
...
public struct GetMyNotesUseCase: GetMyNotesUseCaseInterface {
    ...
    public func execute(
        ...
        return noteAPIService.getMyNotes(
